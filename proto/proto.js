                    ...
                    api.proto = (function() {
                        ...
                        proto.Affinity = (function() {
                            ...
                            Affinity.encode = function encode(message, writer) {
                                ...
                                if (message.nodeAffinity != null && Object.hasOwnProperty.call(message, "nodeAffinity"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeAffinity.encode(message.nodeAffinity, writer.uint32(10).fork()).ldelim();
                                if (message.podAffinity != null && Object.hasOwnProperty.call(message, "podAffinity"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinity.encode(message.podAffinity, writer.uint32(18).fork()).ldelim();
                                if (message.podAntiAffinity != null && Object.hasOwnProperty.call(message, "podAntiAffinity"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAntiAffinity.encode(message.podAntiAffinity, writer.uint32(26).fork()).ldelim();
                                return writer;
                            };
                            ...
                            Affinity.decode = function decode(reader, length) {
                                ...
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Affinity();
                            ...
                            Affinity.verify = function verify(message) {
                                ...
                                if (message.nodeAffinity != null && message.hasOwnProperty("nodeAffinity")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeAffinity.verify(message.nodeAffinity);
                                    if (error)
                                        return "nodeAffinity." + error;
                                }
                                if (message.podAffinity != null && message.hasOwnProperty("podAffinity")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinity.verify(message.podAffinity);
                                    if (error)
                                        return "podAffinity." + error;
                                }
                                if (message.podAntiAffinity != null && message.hasOwnProperty("podAntiAffinity")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAntiAffinity.verify(message.podAntiAffinity);
                                    if (error)
                            ...
                            ConfigMap.encode = function encode(message, writer) {
                                ...
                                if (message.data != null && Object.hasOwnProperty.call(message, "data"))
                                    for (let keys = Object.keys(message.data), i = 0; i < keys.length; ++i)
                                        writer.uint32(26).fork().uint32(10).string(keys[i]).uint32(18).string(message.data[keys[i]]).ldelim();
                                return writer;
                            };
                        ...
                        proto.ConfigMapVolumeSource = (function() {
                            ...
                            ConfigMapVolumeSource.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.KeyToPath.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                            ...
                            ConfigMapVolumeSource.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ConfigMapVolumeSource();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            ConfigMapVolumeSource.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.KeyToPath.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.ContainerPort = (function() {
                            ...
                            ContainerPort.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ContainerPort();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.EnvVar = (function() {
                            ...
                            EnvVar.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.EnvVar();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.HarborHub = (function() {
                            ...
                            HarborHub.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborHub();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.HarborHubList = (function() {
                            ...
                            HarborHubList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborHub.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HarborHubList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborHubList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HarborHubList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborHub.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.HarborProject = (function() {
                            ...
                            HarborProject.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborProject();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.HarborProjectList = (function() {
                            ...
                            HarborProjectList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborProject.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HarborProjectList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborProjectList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HarborProjectList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborProject.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.HarborRepository = (function() {
                            ...
                            HarborRepository.encode = function encode(message, writer) {
                                ...
                                if (message.repositoryId != null && Object.hasOwnProperty.call(message, "repositoryId"))
                                    writer.uint32(8).int32(message.repositoryId);
                                if (message.name != null && Object.hasOwnProperty.call(message, "name"))
                                    writer.uint32(18).string(message.name);
                                if (message.projectId != null && Object.hasOwnProperty.call(message, "projectId"))
                            ...
                            HarborRepository.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRepository();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HarborRepository.verify = function verify(message) {
                                ...
                                if (message.repositoryId != null && message.hasOwnProperty("repositoryId"))
                                    if (!$util.isInteger(message.repositoryId))
                                        return "repositoryId: integer expected";
                                if (message.name != null && message.hasOwnProperty("name"))
                                    if (!$util.isString(message.name))
                                        return "name: string expected";
                                if (message.projectId != null && message.hasOwnProperty("projectId"))
                        ...
                        proto.HarborRepositoryList = (function() {
                            ...
                            HarborRepositoryList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRepository.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HarborRepositoryList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRepositoryList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HarborRepositoryList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRepository.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.HarborRequest = (function() {
                            ...
                            HarborRequest.encode = function encode(message, writer) {
                                if (!writer)
                                    writer = $Writer.create();
                                if (message.harborUrl != null && Object.hasOwnProperty.call(message, "harborUrl"))
                                    writer.uint32(10).string(message.harborUrl);
                            ...
                            HarborRequest.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRequest();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HarborRequest.verify = function verify(message) {
                                ...
                                if (message.harborUrl != null && message.hasOwnProperty("harborUrl"))
                                    if (!$util.isString(message.harborUrl))
                                        return "harborUrl: string expected";
                        ...
                        proto.HarborTag = (function() {
                            ...
                            HarborTag.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborTag();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.HarborTagList = (function() {
                            ...
                            HarborTagList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborTag.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HarborTagList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborTagList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HarborTagList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborTag.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.HelixSagaApp = (function() {
                            ...
                            HelixSagaApp.encode = function encode(message, writer) {
                                ...
                                if (message.spec != null && Object.hasOwnProperty.call(message, "spec"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSpec.encode(message.spec, writer.uint32(10).fork()).ldelim();
                                if (message.command != null && message.command.length)
                                    for (let i = 0; i < message.command.length; ++i)
                                        writer.uint32(18).string(message.command[i]);
                                if (message.args != null && message.args.length)
                                    for (let i = 0; i < message.args.length; ++i)
                                        writer.uint32(26).string(message.args[i]);
                                if (message.watchPolicy != null && Object.hasOwnProperty.call(message, "watchPolicy"))
                                    writer.uint32(34).string(message.watchPolicy);
                                if (message.nodeSelector != null && Object.hasOwnProperty.call(message, "nodeSelector"))
                                    for (let keys = Object.keys(message.nodeSelector), i = 0; i < keys.length; ++i)
                                        writer.uint32(42).fork().uint32(10).string(keys[i]).uint32(18).string(message.nodeSelector[keys[i]]).ldelim();
                                ...
                                if (message.affinity != null && Object.hasOwnProperty.call(message, "affinity"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Affinity.encode(message.affinity, writer.uint32(58).fork()).ldelim();
                                if (message.tolerations != null && message.tolerations.length)
                                    for (let i = 0; i < message.tolerations.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Toleration.encode(message.tolerations[i], writer.uint32(66).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HelixSagaApp.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaApp(), key;
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HelixSagaApp.verify = function verify(message) {
                                ...
                                if (message.spec != null && message.hasOwnProperty("spec")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSpec.verify(message.spec);
                                    if (error)
                                        return "spec." + error;
                                }
                                if (message.command != null && message.hasOwnProperty("command")) {
                                ...
                                if (message.watchPolicy != null && message.hasOwnProperty("watchPolicy"))
                                    if (!$util.isString(message.watchPolicy))
                                        return "watchPolicy: string expected";
                                if (message.nodeSelector != null && message.hasOwnProperty("nodeSelector")) {
                                    ...
                                    let key = Object.keys(message.nodeSelector);
                                    for (let i = 0; i < key.length; ++i)
                                ...
                                if (message.affinity != null && message.hasOwnProperty("affinity")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Affinity.verify(message.affinity);
                                    if (error)
                                ...
                                if (message.tolerations != null && message.hasOwnProperty("tolerations")) {
                                    ...
                                    for (let i = 0; i < message.tolerations.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Toleration.verify(message.tolerations[i]);
                                        if (error)
                        ...
                        proto.HelixSagaConfigMapVolume = (function() {
                            ...
                            HelixSagaConfigMapVolume.encode = function encode(message, writer) {
                                ...
                                if (message.volume != null && Object.hasOwnProperty.call(message, "volume"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Volume.encode(message.volume, writer.uint32(10).fork()).ldelim();
                                if (message.volumeMount != null && Object.hasOwnProperty.call(message, "volumeMount"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.VolumeMount.encode(message.volumeMount, writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HelixSagaConfigMapVolume.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaConfigMapVolume();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HelixSagaConfigMapVolume.verify = function verify(message) {
                                ...
                                if (message.volume != null && message.hasOwnProperty("volume")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Volume.verify(message.volume);
                                    if (error)
                                        return "volume." + error;
                                }
                                if (message.volumeMount != null && message.hasOwnProperty("volumeMount")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.VolumeMount.verify(message.volumeMount);
                                    if (error)
                                        return "volumeMount." + error;
                                }
                                return null;
                            };
                        ...
                        proto.HelixSagaCrd = (function() {
                            ...
                            HelixSagaCrd.encode = function encode(message, writer) {
                                ...
                                if (message.configMap != null && Object.hasOwnProperty.call(message, "configMap"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaConfigMapVolume.encode(message.configMap, writer.uint32(26).fork()).ldelim();
                                if (message.applications != null && message.applications.length)
                                    for (let i = 0; i < message.applications.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaApp.encode(message.applications[i], writer.uint32(34).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HelixSagaCrd.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaCrd();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HelixSagaCrd.verify = function verify(message) {
                                ...
                                if (message.configMap != null && message.hasOwnProperty("configMap")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaConfigMapVolume.verify(message.configMap);
                                    if (error)
                                ...
                                if (message.applications != null && message.hasOwnProperty("applications")) {
                                    ...
                                    for (let i = 0; i < message.applications.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaApp.verify(message.applications[i]);
                                        if (error)
                        ...
                        proto.HelixSagaCrdList = (function() {
                            ...
                            HelixSagaCrdList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaCrd.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            HelixSagaCrdList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaCrdList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            HelixSagaCrdList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HelixSagaCrd.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.KeyToPath = (function() {
                            ...
                            KeyToPath.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.KeyToPath();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.LabelSelector = (function() {
                            ...
                            LabelSelector.encode = function encode(message, writer) {
                                ...
                                if (message.matchLabels != null && Object.hasOwnProperty.call(message, "matchLabels"))
                                    for (let keys = Object.keys(message.matchLabels), i = 0; i < keys.length; ++i)
                                        writer.uint32(10).fork().uint32(10).string(keys[i]).uint32(18).string(message.matchLabels[keys[i]]).ldelim();
                                if (message.matchExpressions != null && message.matchExpressions.length)
                                    for (let i = 0; i < message.matchExpressions.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement.encode(message.matchExpressions[i], writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            LabelSelector.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector(), key;
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                    ...
                                    case 2:
                                        ...
                                        message.matchExpressions.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement.decode(reader, reader.uint32()));
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            LabelSelector.verify = function verify(message) {
                                ...
                                if (message.matchExpressions != null && message.hasOwnProperty("matchExpressions")) {
                                    ...
                                    for (let i = 0; i < message.matchExpressions.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement.verify(message.matchExpressions[i]);
                                        if (error)
                        ...
                        proto.LabelSelectorRequirement = (function() {
                            ...
                            LabelSelectorRequirement.encode = function encode(message, writer) {
                                ...
                                if (message.values != null && message.values.length)
                                    for (let i = 0; i < message.values.length; ++i)
                                        writer.uint32(26).string(message.values[i]);
                                return writer;
                            };
                            ...
                            LabelSelectorRequirement.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.MysqlCrd = (function() {
                            ...
                            MysqlCrd.encode = function encode(message, writer) {
                                ...
                                if (message.master != null && Object.hasOwnProperty.call(message, "master"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSpec.encode(message.master, writer.uint32(26).fork()).ldelim();
                                if (message.slave != null && Object.hasOwnProperty.call(message, "slave"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSpec.encode(message.slave, writer.uint32(34).fork()).ldelim();
                                return writer;
                            };
                        ...
                        proto.NodeAffinity = (function() {
                            ...
                            NodeAffinity.encode = function encode(message, writer) {
                                ...
                                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && Object.hasOwnProperty.call(message, "requiredDuringSchedulingIgnoredDuringExecution"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector.encode(message.requiredDuringSchedulingIgnoredDuringExecution, writer.uint32(10).fork()).ldelim();
                                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.preferredDuringSchedulingIgnoredDuringExecution.length)
                                    for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm.encode(message.preferredDuringSchedulingIgnoredDuringExecution[i], writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            NodeAffinity.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeAffinity();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        message.requiredDuringSchedulingIgnoredDuringExecution = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector.decode(reader, reader.uint32());
                                        break;
                                    case 2:
                                        ...
                                        message.preferredDuringSchedulingIgnoredDuringExecution.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm.decode(reader, reader.uint32()));
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            NodeAffinity.verify = function verify(message) {
                                ...
                                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty("requiredDuringSchedulingIgnoredDuringExecution")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector.verify(message.requiredDuringSchedulingIgnoredDuringExecution);
                                    if (error)
                                ...
                                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty("preferredDuringSchedulingIgnoredDuringExecution")) {
                                    ...
                                    for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm.verify(message.preferredDuringSchedulingIgnoredDuringExecution[i]);
                                        if (error)
                        ...
                        proto.NodeSelector = (function() {
                            ...
                            NodeSelector.encode = function encode(message, writer) {
                                ...
                                if (message.nodeSelectorTerms != null && message.nodeSelectorTerms.length)
                                    for (let i = 0; i < message.nodeSelectorTerms.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.encode(message.nodeSelectorTerms[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            NodeSelector.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        ...
                                        message.nodeSelectorTerms.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.decode(reader, reader.uint32()));
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            NodeSelector.verify = function verify(message) {
                                ...
                                if (message.nodeSelectorTerms != null && message.hasOwnProperty("nodeSelectorTerms")) {
                                    ...
                                    for (let i = 0; i < message.nodeSelectorTerms.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.verify(message.nodeSelectorTerms[i]);
                                        if (error)
                        ...
                        proto.NodeSelectorRequirement = (function() {
                            ...
                            NodeSelectorRequirement.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.NodeSelectorTerm = (function() {
                            ...
                            NodeSelectorTerm.encode = function encode(message, writer) {
                                ...
                                if (message.matchExpressions != null && message.matchExpressions.length)
                                    for (let i = 0; i < message.matchExpressions.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.encode(message.matchExpressions[i], writer.uint32(10).fork()).ldelim();
                                if (message.matchFields != null && message.matchFields.length)
                                    for (let i = 0; i < message.matchFields.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.encode(message.matchFields[i], writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            NodeSelectorTerm.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        if (!(message.matchExpressions && message.matchExpressions.length))
                                            message.matchExpressions = [];
                                        message.matchExpressions.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.decode(reader, reader.uint32()));
                                        break;
                                    case 2:
                                        if (!(message.matchFields && message.matchFields.length))
                                            message.matchFields = [];
                                        message.matchFields.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.decode(reader, reader.uint32()));
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            NodeSelectorTerm.verify = function verify(message) {
                                ...
                                if (message.matchExpressions != null && message.hasOwnProperty("matchExpressions")) {
                                    if (!Array.isArray(message.matchExpressions))
                                        return "matchExpressions: array expected";
                                    for (let i = 0; i < message.matchExpressions.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.verify(message.matchExpressions[i]);
                                        if (error)
                                            return "matchExpressions." + error;
                                    }
                                }
                                if (message.matchFields != null && message.hasOwnProperty("matchFields")) {
                                    ...
                                    for (let i = 0; i < message.matchFields.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.verify(message.matchFields[i]);
                                        if (error)
                        ...
                        proto.NodeSpec = (function() {
                            ...
                            NodeSpec.encode = function encode(message, writer) {
                                ...
                                if (message.containerPorts != null && message.containerPorts.length)
                                    for (let i = 0; i < message.containerPorts.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ContainerPort.encode(message.containerPorts[i], writer.uint32(58).fork()).ldelim();
                                if (message.servicePorts != null && message.servicePorts.length)
                                    for (let i = 0; i < message.servicePorts.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServicePort.encode(message.servicePorts[i], writer.uint32(66).fork()).ldelim();
                                if (message.serviceType != null && Object.hasOwnProperty.call(message, "serviceType"))
                                    writer.uint32(74).string(message.serviceType);
                                if (message.env != null && message.env.length)
                                    for (let i = 0; i < message.env.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.EnvVar.encode(message.env[i], writer.uint32(82).fork()).ldelim();
                                if (message.status != null && Object.hasOwnProperty.call(message, "status"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Status.encode(message.status, writer.uint32(90).fork()).ldelim();
                                return writer;
                            };
                            ...
                            NodeSpec.verify = function verify(message) {
                                ...
                                if (message.containerPorts != null && message.hasOwnProperty("containerPorts")) {
                                    if (!Array.isArray(message.containerPorts))
                                        return "containerPorts: array expected";
                                    for (let i = 0; i < message.containerPorts.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ContainerPort.verify(message.containerPorts[i]);
                                        if (error)
                                            return "containerPorts." + error;
                                    }
                                }
                                if (message.servicePorts != null && message.hasOwnProperty("servicePorts")) {
                                    if (!Array.isArray(message.servicePorts))
                                        return "servicePorts: array expected";
                                    for (let i = 0; i < message.servicePorts.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServicePort.verify(message.servicePorts[i]);
                                        if (error)
                                            return "servicePorts." + error;
                                    }
                                }
                                ...
                                if (message.env != null && message.hasOwnProperty("env")) {
                                    ...
                                    for (let i = 0; i < message.env.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.EnvVar.verify(message.env[i]);
                                        if (error)
                                            return "env." + error;
                                    }
                                }
                                if (message.status != null && message.hasOwnProperty("status")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Status.verify(message.status);
                                    if (error)
                                        return "status." + error;
                                }
                                return null;
                        ...
                        proto.Param = (function() {
                            ...
                            Param.encode = function encode(message, writer) {
                                ...
                                if (message.watchEventType != null && Object.hasOwnProperty.call(message, "watchEventType"))
                                    writer.uint32(34).string(message.watchEventType);
                                if (message.harborRequest != null && Object.hasOwnProperty.call(message, "harborRequest"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRequest.encode(message.harborRequest, writer.uint32(42).fork()).ldelim();
                                return writer;
                            };
                            ...
                            Param.verify = function verify(message) {
                                ...
                                if (message.watchEventType != null && message.hasOwnProperty("watchEventType"))
                                    if (!$util.isString(message.watchEventType))
                                        return "watchEventType: string expected";
                                if (message.harborRequest != null && message.hasOwnProperty("harborRequest")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.HarborRequest.verify(message.harborRequest);
                                    if (error)
                                        return "harborRequest." + error;
                                }
                                return null;
                            };
                        ...
                        proto.Pod = (function() {
                            ...
                            Pod.encode = function encode(message, writer) {
                                ...
                                if (message.containerNames != null && message.containerNames.length)
                                    for (let i = 0; i < message.containerNames.length; ++i)
                                        writer.uint32(34).string(message.containerNames[i]);
                                if (message.status != null && Object.hasOwnProperty.call(message, "status"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodStatus.encode(message.status, writer.uint32(42).fork()).ldelim();
                                return writer;
                            };
                            ...
                            Pod.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Pod();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        if (!(message.containerNames && message.containerNames.length))
                                            message.containerNames = [];
                            ...
                            Pod.verify = function verify(message) {
                                ...
                                if (message.containerNames != null && message.hasOwnProperty("containerNames")) {
                                    if (!Array.isArray(message.containerNames))
                                        return "containerNames: array expected";
                                    for (let i = 0; i < message.containerNames.length; ++i)
                                        if (!$util.isString(message.containerNames[i]))
                                            return "containerNames: string[] expected";
                                }
                                if (message.status != null && message.hasOwnProperty("status")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodStatus.verify(message.status);
                                    if (error)
                                        return "status." + error;
                                }
                                return null;
                        ...
                        proto.PodAffinity = (function() {
                            ...
                            PodAffinity.encode = function encode(message, writer) {
                                ...
                                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && message.requiredDuringSchedulingIgnoredDuringExecution.length)
                                    for (let i = 0; i < message.requiredDuringSchedulingIgnoredDuringExecution.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.encode(message.requiredDuringSchedulingIgnoredDuringExecution[i], writer.uint32(10).fork()).ldelim();
                                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.preferredDuringSchedulingIgnoredDuringExecution.length)
                                    for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm.encode(message.preferredDuringSchedulingIgnoredDuringExecution[i], writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            PodAffinity.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinity();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        ...
                                        message.requiredDuringSchedulingIgnoredDuringExecution.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.decode(reader, reader.uint32()));
                                        break;
                                    case 2:
                                        if (!(message.preferredDuringSchedulingIgnoredDuringExecution && message.preferredDuringSchedulingIgnoredDuringExecution.length))
                                            message.preferredDuringSchedulingIgnoredDuringExecution = [];
                                        message.preferredDuringSchedulingIgnoredDuringExecution.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm.decode(reader, reader.uint32()));
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            PodAffinity.verify = function verify(message) {
                                ...
                                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty("requiredDuringSchedulingIgnoredDuringExecution")) {
                                    ...
                                    for (let i = 0; i < message.requiredDuringSchedulingIgnoredDuringExecution.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.verify(message.requiredDuringSchedulingIgnoredDuringExecution[i]);
                                        if (error)
                                            return "requiredDuringSchedulingIgnoredDuringExecution." + error;
                                    }
                                }
                                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty("preferredDuringSchedulingIgnoredDuringExecution")) {
                                    if (!Array.isArray(message.preferredDuringSchedulingIgnoredDuringExecution))
                                        return "preferredDuringSchedulingIgnoredDuringExecution: array expected";
                                    for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm.verify(message.preferredDuringSchedulingIgnoredDuringExecution[i]);
                                        if (error)
                                            return "preferredDuringSchedulingIgnoredDuringExecution." + error;
                                    }
                                }
                        ...
                        proto.PodAffinityTerm = (function() {
                            ...
                            PodAffinityTerm.encode = function encode(message, writer) {
                                ...
                                if (message.labelSelector != null && Object.hasOwnProperty.call(message, "labelSelector"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector.encode(message.labelSelector, writer.uint32(10).fork()).ldelim();
                                if (message.namespaces != null && message.namespaces.length)
                                    for (let i = 0; i < message.namespaces.length; ++i)
                                        writer.uint32(18).string(message.namespaces[i]);
                                if (message.topologyKey != null && Object.hasOwnProperty.call(message, "topologyKey"))
                                    writer.uint32(26).string(message.topologyKey);
                                return writer;
                            };
                            ...
                            PodAffinityTerm.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        message.labelSelector = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector.decode(reader, reader.uint32());
                                        break;
                                    case 2:
                            ...
                            PodAffinityTerm.verify = function verify(message) {
                                ...
                                if (message.labelSelector != null && message.hasOwnProperty("labelSelector")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector.verify(message.labelSelector);
                                    if (error)
                        ...
                        proto.PodAntiAffinity = (function() {
                            ...
                            PodAntiAffinity.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAntiAffinity();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.PodList = (function() {
                            ...
                            PodList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Pod.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            PodList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            PodList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Pod.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.PodStatus = (function() {
                            ...
                            PodStatus.encode = function encode(message, writer) {
                                ...
                                if (message.hostIP != null && Object.hasOwnProperty.call(message, "hostIP"))
                                    writer.uint32(18).string(message.hostIP);
                                if (message.podIP != null && Object.hasOwnProperty.call(message, "podIP"))
                                    writer.uint32(26).string(message.podIP);
                                return writer;
                            };
                            ...
                            PodStatus.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodStatus();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.PreferredSchedulingTerm = (function() {
                            ...
                            PreferredSchedulingTerm.encode = function encode(message, writer) {
                                ...
                                if (message.preference != null && Object.hasOwnProperty.call(message, "preference"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.encode(message.preference, writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            PreferredSchedulingTerm.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        message.preference = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.decode(reader, reader.uint32());
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            PreferredSchedulingTerm.verify = function verify(message) {
                                ...
                                if (message.preference != null && message.hasOwnProperty("preference")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.verify(message.preference);
                                    if (error)
                        ...
                        proto.Secret = (function() {
                            ...
                            Secret.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Secret();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.SecretList = (function() {
                            ...
                            SecretList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Secret.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            SecretList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.SecretList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            SecretList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Secret.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.ServiceAccount = (function() {
                            ...
                            ServiceAccount.prototype.nameSpace = "";
                            ...
                            ServiceAccount.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.ServiceAccountList = (function() {
                            ...
                            ServiceAccountList.encode = function encode(message, writer) {
                                ...
                                if (message.items != null && message.items.length)
                                    for (let i = 0; i < message.items.length; ++i)
                                        $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount.encode(message.items[i], writer.uint32(10).fork()).ldelim();
                                return writer;
                            };
                            ...
                            ServiceAccountList.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccountList();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        if (!(message.items && message.items.length))
                                            message.items = [];
                                        message.items.push($root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount.decode(reader, reader.uint32()));
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            ServiceAccountList.verify = function verify(message) {
                                ...
                                if (message.items != null && message.hasOwnProperty("items")) {
                                    if (!Array.isArray(message.items))
                                        return "items: array expected";
                                    for (let i = 0; i < message.items.length; ++i) {
                                        let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount.verify(message.items[i]);
                                        if (error)
                                            return "items." + error;
                                    }
                                }
                        ...
                        proto.Status = (function() {
                            ...
                            Status.encode = function encode(message, writer) {
                                ...
                                if (message.currentReplicas != null && Object.hasOwnProperty.call(message, "currentReplicas"))
                                    writer.uint32(32).int32(message.currentReplicas);
                                if (message.updatedReplicas != null && Object.hasOwnProperty.call(message, "updatedReplicas"))
                                ...
                                if (message.updateRevision != null && Object.hasOwnProperty.call(message, "updateRevision"))
                                    writer.uint32(58).string(message.updateRevision);
                                if (message.collisionCount != null && Object.hasOwnProperty.call(message, "collisionCount"))
                            ...
                            Status.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Status();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            Status.verify = function verify(message) {
                                ...
                                if (message.currentRevision != null && message.hasOwnProperty("currentRevision"))
                                    if (!$util.isString(message.currentRevision))
                                        return "currentRevision: string expected";
                                if (message.updateRevision != null && message.hasOwnProperty("updateRevision"))
                                    if (!$util.isString(message.updateRevision))
                                        return "updateRevision: string expected";
                                if (message.collisionCount != null && message.hasOwnProperty("collisionCount"))
                                    if (!$util.isInteger(message.collisionCount))
                                        return "collisionCount: integer expected";
                                return null;
                            };
                        ...
                        proto.Toleration = (function() {
                            ...
                            Toleration.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Toleration();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.Volume = (function() {
                            ...
                            Volume.encode = function encode(message, writer) {
                                ...
                                if (message.volumeSource != null && Object.hasOwnProperty.call(message, "volumeSource"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.VolumeSource.encode(message.volumeSource, writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            Volume.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Volume();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            Volume.verify = function verify(message) {
                                ...
                                if (message.volumeSource != null && message.hasOwnProperty("volumeSource")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.VolumeSource.verify(message.volumeSource);
                                    if (error)
                        ...
                        proto.VolumeMount = (function() {
                            ...
                            VolumeMount.encode = function encode(message, writer) {
                                ...
                                if (message.subPath != null && Object.hasOwnProperty.call(message, "subPath"))
                                    writer.uint32(34).string(message.subPath);
                                if (message.subPathExpr != null && Object.hasOwnProperty.call(message, "subPathExpr"))
                                    writer.uint32(50).string(message.subPathExpr);
                                return writer;
                            };
                            ...
                            VolumeMount.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.VolumeMount();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                        ...
                        proto.VolumeSource = (function() {
                            ...
                            VolumeSource.encode = function encode(message, writer) {
                                ...
                                if (message.name != null && Object.hasOwnProperty.call(message, "name"))
                                    writer.uint32(10).string(message.name);
                                if (message.configMap != null && Object.hasOwnProperty.call(message, "configMap"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ConfigMapVolumeSource.encode(message.configMap, writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            VolumeSource.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.VolumeSource();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                            ...
                            VolumeSource.verify = function verify(message) {
                                ...
                                if (message.name != null && message.hasOwnProperty("name"))
                                    if (!$util.isString(message.name))
                                        return "name: string expected";
                                if (message.configMap != null && message.hasOwnProperty("configMap")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ConfigMapVolumeSource.verify(message.configMap);
                                    if (error)
                                        return "configMap." + error;
                                }
                                return null;
                        ...
                        proto.WeightedPodAffinityTerm = (function() {
                            ...
                            WeightedPodAffinityTerm.encode = function encode(message, writer) {
                                ...
                                if (message.podAffinityTerm != null && Object.hasOwnProperty.call(message, "podAffinityTerm"))
                                    $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.encode(message.podAffinityTerm, writer.uint32(18).fork()).ldelim();
                                return writer;
                            };
                            ...
                            WeightedPodAffinityTerm.decode = function decode(reader, length) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm();
                                while (reader.pos < end) {
                                    let tag = reader.uint32();
                                    switch (tag >>> 3) {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        message.podAffinityTerm = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.decode(reader, reader.uint32());
                                        break;
                                    default:
                                        reader.skipType(tag & 7);
                                        break;
                            ...
                            WeightedPodAffinityTerm.verify = function verify(message) {
                                ...
                                if (message.podAffinityTerm != null && message.hasOwnProperty("podAffinityTerm")) {
                                    let error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.verify(message.podAffinityTerm);
                                    if (error)
