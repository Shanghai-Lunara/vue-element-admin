          ...
          api.proto = (function() {
            ...
            proto.Affinity = (function() {
              ...
              Affinity.decode = function decode(reader, length) {
                ...
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Affinity()
            ...
            proto.HelixSagaAppSpec = (function() {
              ...
              HelixSagaAppSpec.verify = function verify(message) {
                ...
                if (message.serviceAccountName != null && message.hasOwnProperty('serviceAccountName')) {
                  if (!$util.isString(message.serviceAccountName)) { return 'serviceAccountName: string expected' }
                }
                if (message.affinity != null && message.hasOwnProperty('affinity')) {
                  const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Affinity.verify(message.affinity)
                  if (error) { return 'affinity.' + error }
                }
                if (message.tolerations != null && message.hasOwnProperty('tolerations')) {
                  if (!Array.isArray(message.tolerations)) { return 'tolerations: array expected' }
                  for (let i = 0; i < message.tolerations.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Toleration.verify(message.tolerations[i])
            ...
            proto.LabelSelector = (function() {
              ...
              LabelSelector.encode = function encode(message, writer) {
                ...
                if (message.matchLabels != null && Object.hasOwnProperty.call(message, 'matchLabels')) {
                  for (let keys = Object.keys(message.matchLabels), i = 0; i < keys.length; ++i) { writer.uint32(10).fork().uint32(10).string(keys[i]).uint32(18).string(message.matchLabels[keys[i]]).ldelim() }
                }
                if (message.matchExpressions != null && message.matchExpressions.length) {
                  for (let i = 0; i < message.matchExpressions.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement.encode(message.matchExpressions[i], writer.uint32(18).fork()).ldelim() }
                }
                return writer
              }
              ...
              LabelSelector.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector(); let key
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
                      reader.skip().pos++
                      if (message.matchLabels === $util.emptyObject) { message.matchLabels = {} }
                      key = reader.string()
                      reader.pos++
                      message.matchLabels[key] = reader.string()
                      break
                    case 2:
                      if (!(message.matchExpressions && message.matchExpressions.length)) { message.matchExpressions = [] }
              ...
              LabelSelector.verify = function verify(message) {
                ...
                if (message.matchLabels != null && message.hasOwnProperty('matchLabels')) {
                  if (!$util.isObject(message.matchLabels)) { return 'matchLabels: object expected' }
                  const key = Object.keys(message.matchLabels)
                  for (let i = 0; i < key.length; ++i) {
                    if (!$util.isString(message.matchLabels[key[i]])) { return 'matchLabels: string{k:string} expected' }
                  }
                }
                if (message.matchExpressions != null && message.hasOwnProperty('matchExpressions')) {
                  if (!Array.isArray(message.matchExpressions)) { return 'matchExpressions: array expected' }
                  for (let i = 0; i < message.matchExpressions.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement.verify(message.matchExpressions[i])
                    if (error) { return 'matchExpressions.' + error }
                  }
                }
                return null
              }
            ...
            proto.LabelSelectorRequirement = (function() {
              ...
              LabelSelectorRequirement.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.key != null && Object.hasOwnProperty.call(message, 'key')) { writer.uint32(10).string(message.key) }
                if (message.operator != null && Object.hasOwnProperty.call(message, 'operator')) { writer.uint32(18).string(message.operator) }
                if (message.values != null && message.values.length) {
                  for (let i = 0; i < message.values.length; ++i) { writer.uint32(26).string(message.values[i]) }
                }
                return writer
              }
              ...
              LabelSelectorRequirement.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelectorRequirement()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
            ...
            proto.NodeAffinity = (function() {
              ...
              NodeAffinity.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && Object.hasOwnProperty.call(message, 'requiredDuringSchedulingIgnoredDuringExecution')) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector.encode(message.requiredDuringSchedulingIgnoredDuringExecution, writer.uint32(10).fork()).ldelim() }
                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.preferredDuringSchedulingIgnoredDuringExecution.length) {
                  for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm.encode(message.preferredDuringSchedulingIgnoredDuringExecution[i], writer.uint32(18).fork()).ldelim() }
                }
                return writer
              }
              ...
              NodeAffinity.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeAffinity()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
                      ...
                      break
                    case 2:
                      if (!(message.preferredDuringSchedulingIgnoredDuringExecution && message.preferredDuringSchedulingIgnoredDuringExecution.length)) { message.preferredDuringSchedulingIgnoredDuringExecution = [] }
              ...
              NodeAffinity.verify = function verify(message) {
                ...
                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty('requiredDuringSchedulingIgnoredDuringExecution')) {
                  const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector.verify(message.requiredDuringSchedulingIgnoredDuringExecution)
                  if (error) { return 'requiredDuringSchedulingIgnoredDuringExecution.' + error }
                }
                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty('preferredDuringSchedulingIgnoredDuringExecution')) {
                  if (!Array.isArray(message.preferredDuringSchedulingIgnoredDuringExecution)) { return 'preferredDuringSchedulingIgnoredDuringExecution: array expected' }
                  for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm.verify(message.preferredDuringSchedulingIgnoredDuringExecution[i])
                    if (error) { return 'preferredDuringSchedulingIgnoredDuringExecution.' + error }
                  }
                }
                return null
              }
            ...
            proto.NodeSelector = (function() {
              ...
              NodeSelector.encode = function encode(message, writer) {
                ...
                if (message.nodeSelectorTerms != null && message.nodeSelectorTerms.length) {
                  for (let i = 0; i < message.nodeSelectorTerms.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.encode(message.nodeSelectorTerms[i], writer.uint32(10).fork()).ldelim() }
                }
                return writer
              }
              ...
              NodeSelector.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelector()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
                      if (!(message.nodeSelectorTerms && message.nodeSelectorTerms.length)) { message.nodeSelectorTerms = [] }
              ...
              NodeSelector.verify = function verify(message) {
                ...
                if (message.nodeSelectorTerms != null && message.hasOwnProperty('nodeSelectorTerms')) {
                  if (!Array.isArray(message.nodeSelectorTerms)) { return 'nodeSelectorTerms: array expected' }
                  for (let i = 0; i < message.nodeSelectorTerms.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.verify(message.nodeSelectorTerms[i])
                    if (error) { return 'nodeSelectorTerms.' + error }
                  }
                }
                return null
              }
            ...
            proto.NodeSelectorRequirement = (function() {
              ...
              NodeSelectorRequirement.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
            ...
            proto.NodeSelectorTerm = (function() {
              ...
              NodeSelectorTerm.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.matchExpressions != null && message.matchExpressions.length) {
                  for (let i = 0; i < message.matchExpressions.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.encode(message.matchExpressions[i], writer.uint32(10).fork()).ldelim() }
                }
                if (message.matchFields != null && message.matchFields.length) {
                  for (let i = 0; i < message.matchFields.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.encode(message.matchFields[i], writer.uint32(18).fork()).ldelim() }
                }
                return writer
              }
              ...
              NodeSelectorTerm.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
                      ...
                      break
                    case 2:
                      if (!(message.matchFields && message.matchFields.length)) { message.matchFields = [] }
              ...
              NodeSelectorTerm.verify = function verify(message) {
                ...
                if (message.matchExpressions != null && message.hasOwnProperty('matchExpressions')) {
                  if (!Array.isArray(message.matchExpressions)) { return 'matchExpressions: array expected' }
                  for (let i = 0; i < message.matchExpressions.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.verify(message.matchExpressions[i])
                    if (error) { return 'matchExpressions.' + error }
                  }
                }
                if (message.matchFields != null && message.hasOwnProperty('matchFields')) {
                  if (!Array.isArray(message.matchFields)) { return 'matchFields: array expected' }
                  for (let i = 0; i < message.matchFields.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorRequirement.verify(message.matchFields[i])
                    if (error) { return 'matchFields.' + error }
                  }
                }
                return null
              }
            ...
            proto.PodAffinity = (function() {
              ...
              PodAffinity.encode = function encode(message, writer) {
                ...
                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && message.requiredDuringSchedulingIgnoredDuringExecution.length) {
                  for (let i = 0; i < message.requiredDuringSchedulingIgnoredDuringExecution.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.encode(message.requiredDuringSchedulingIgnoredDuringExecution[i], writer.uint32(10).fork()).ldelim() }
                }
                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.preferredDuringSchedulingIgnoredDuringExecution.length) {
                  for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm.encode(message.preferredDuringSchedulingIgnoredDuringExecution[i], writer.uint32(18).fork()).ldelim() }
                }
                return writer
              }
              ...
              PodAffinity.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinity()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
                      if (!(message.requiredDuringSchedulingIgnoredDuringExecution && message.requiredDuringSchedulingIgnoredDuringExecution.length)) { message.requiredDuringSchedulingIgnoredDuringExecution = [] }
              ...
              PodAffinity.verify = function verify(message) {
                if (typeof message !== 'object' || message === null) { return 'object expected' }
                if (message.requiredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty('requiredDuringSchedulingIgnoredDuringExecution')) {
                  if (!Array.isArray(message.requiredDuringSchedulingIgnoredDuringExecution)) { return 'requiredDuringSchedulingIgnoredDuringExecution: array expected' }
                  for (let i = 0; i < message.requiredDuringSchedulingIgnoredDuringExecution.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.verify(message.requiredDuringSchedulingIgnoredDuringExecution[i])
                    if (error) { return 'requiredDuringSchedulingIgnoredDuringExecution.' + error }
                  }
                }
                if (message.preferredDuringSchedulingIgnoredDuringExecution != null && message.hasOwnProperty('preferredDuringSchedulingIgnoredDuringExecution')) {
                  if (!Array.isArray(message.preferredDuringSchedulingIgnoredDuringExecution)) { return 'preferredDuringSchedulingIgnoredDuringExecution: array expected' }
                  for (let i = 0; i < message.preferredDuringSchedulingIgnoredDuringExecution.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm.verify(message.preferredDuringSchedulingIgnoredDuringExecution[i])
                    if (error) { return 'preferredDuringSchedulingIgnoredDuringExecution.' + error }
                  }
                }
                return null
            ...
            proto.PodAffinityTerm = (function() {
              ...
              PodAffinityTerm.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.labelSelector != null && Object.hasOwnProperty.call(message, 'labelSelector')) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector.encode(message.labelSelector, writer.uint32(10).fork()).ldelim() }
                if (message.namespaces != null && message.namespaces.length) {
                  for (let i = 0; i < message.namespaces.length; ++i) { writer.uint32(18).string(message.namespaces[i]) }
                }
                if (message.topologyKey != null && Object.hasOwnProperty.call(message, 'topologyKey')) { writer.uint32(26).string(message.topologyKey) }
                return writer
              }
              ...
              PodAffinityTerm.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
                      ...
                      break
                    case 2:
                      if (!(message.namespaces && message.namespaces.length)) { message.namespaces = [] }
              ...
              PodAffinityTerm.verify = function verify(message) {
                ...
                if (message.labelSelector != null && message.hasOwnProperty('labelSelector')) {
                  const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.LabelSelector.verify(message.labelSelector)
                  if (error) { return 'labelSelector.' + error }
                }
                if (message.namespaces != null && message.hasOwnProperty('namespaces')) {
                  ...
                  for (let i = 0; i < message.namespaces.length; ++i) {
                    if (!$util.isString(message.namespaces[i])) { return 'namespaces: string[] expected' }
                  }
                }
                if (message.topologyKey != null && message.hasOwnProperty('topologyKey')) {
                  if (!$util.isString(message.topologyKey)) { return 'topologyKey: string expected' }
                }
                return null
              }
            ...
            proto.PodAntiAffinity = (function() {
              ...
              PodAntiAffinity.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAntiAffinity()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
            ...
            proto.PreferredSchedulingTerm = (function() {
              ...
              PreferredSchedulingTerm.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.weight != null && Object.hasOwnProperty.call(message, 'weight')) { writer.uint32(8).int32(message.weight) }
                if (message.preference != null && Object.hasOwnProperty.call(message, 'preference')) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.encode(message.preference, writer.uint32(18).fork()).ldelim() }
                return writer
              }
              ...
              PreferredSchedulingTerm.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PreferredSchedulingTerm()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
              ...
              PreferredSchedulingTerm.verify = function verify(message) {
                ...
                if (message.preference != null && message.hasOwnProperty('preference')) {
                  const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.NodeSelectorTerm.verify(message.preference)
            ...
            proto.ServiceAccount = (function() {
              ...
              ServiceAccount.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
            ...
            proto.ServiceAccountList = (function() {
              ...
              ServiceAccountList.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.items != null && message.items.length) {
                  for (let i = 0; i < message.items.length; ++i) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount.encode(message.items[i], writer.uint32(10).fork()).ldelim() }
                }
                return writer
              }
              ...
              ServiceAccountList.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccountList()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
              ...
              ServiceAccountList.verify = function verify(message) {
                ...
                if (message.items != null && message.hasOwnProperty('items')) {
                  if (!Array.isArray(message.items)) { return 'items: array expected' }
                  for (let i = 0; i < message.items.length; ++i) {
                    const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.ServiceAccount.verify(message.items[i])
                    if (error) { return 'items.' + error }
                  }
                }
                return null
            ...
            proto.Toleration = (function() {
              ...
              Toleration.encode = function encode(message, writer) {
                ...
                if (message.key != null && Object.hasOwnProperty.call(message, 'key')) { writer.uint32(10).string(message.key) }
                if (message.operator != null && Object.hasOwnProperty.call(message, 'operator')) { writer.uint32(18).string(message.operator) }
                if (message.value != null && Object.hasOwnProperty.call(message, 'value')) { writer.uint32(26).string(message.value) }
                if (message.effect != null && Object.hasOwnProperty.call(message, 'effect')) { writer.uint32(34).string(message.effect) }
                if (message.tolerationSeconds != null && Object.hasOwnProperty.call(message, 'tolerationSeconds')) { writer.uint32(40).int64(message.tolerationSeconds) }
                return writer
              }
              ...
              Toleration.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.Toleration()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
              ...
              Toleration.verify = function verify(message) {
                ...
                if (message.effect != null && message.hasOwnProperty('effect')) {
                  if (!$util.isString(message.effect)) { return 'effect: string expected' }
                }
                if (message.tolerationSeconds != null && message.hasOwnProperty('tolerationSeconds')) {
                  if (!$util.isInteger(message.tolerationSeconds) && !(message.tolerationSeconds && $util.isInteger(message.tolerationSeconds.low) && $util.isInteger(message.tolerationSeconds.high))) { return 'tolerationSeconds: integer|Long expected' }
                }
                return null
              }
            ...
            proto.WeightedPodAffinityTerm = (function() {
              ...
              WeightedPodAffinityTerm.encode = function encode(message, writer) {
                if (!writer) { writer = $Writer.create() }
                if (message.weight != null && Object.hasOwnProperty.call(message, 'weight')) { writer.uint32(8).int32(message.weight) }
                if (message.podAffinityTerm != null && Object.hasOwnProperty.call(message, 'podAffinityTerm')) { $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.encode(message.podAffinityTerm, writer.uint32(18).fork()).ldelim() }
                return writer
              }
              ...
              WeightedPodAffinityTerm.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
                const end = length === undefined ? reader.len : reader.pos + length; const message = new $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.WeightedPodAffinityTerm()
                while (reader.pos < end) {
                  const tag = reader.uint32()
                  switch (tag >>> 3) {
                    case 1:
              ...
              WeightedPodAffinityTerm.verify = function verify(message) {
                ...
                if (message.podAffinityTerm != null && message.hasOwnProperty('podAffinityTerm')) {
                  const error = $root.github.com.nevercase.k8s_controller_custom_resource.api.proto.PodAffinityTerm.verify(message.podAffinityTerm)
                  if (error) { return 'podAffinityTerm.' + error }
                }
                return null
              }
